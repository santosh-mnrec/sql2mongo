...
var total_length = 0;
var arr_orginal = ""; //No I18N

var sql_to_mongodb_sample = "select id,salary from employee where age >= 35 and (designation = 'manager' or (lastname = 'johnson' and firstname like '%john%'))"; //No I18N
...
var r=sql_to_mongodb(sql_to_mongodb_sample);
console.log(r);
